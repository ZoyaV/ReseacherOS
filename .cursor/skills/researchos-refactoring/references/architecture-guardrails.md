...
| `koi/projects/` | project commands, read models, reports, live artifacts, and kanban DAG behavior | HTTP types, unrelated capabilities, persistence details leaking into callers |
