...
`<repo>/koi-structure/onboard-brief.md` по шаблону
[onboard-brief.template.md](onboard-brief.template.md). Это зафиксированные
высокие цели/problem/cause/hyp/method из слоёв 3A–3C. Перед **любым**
написанием или правкой заголовков узлов/карточек (фиксация слоя, clarity loop,
prose-pass, поздние правки дерева) — **перечитай `onboard-brief.md`** и сверяй
titles с ним. Cold reader файл не получает.
...
- Бриф-якорь: [onboard-brief.template.md](onboard-brief.template.md) →
  `koi-structure/onboard-brief.md`
