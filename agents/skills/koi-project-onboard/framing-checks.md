...
### Заголовки узлов и карточек: ≤ 8 слов
...
При фиксации слоя и prose-pass: если title > 8 слов — разрезать: короткий
ярлык + подробности в body/`desc`. Примеры — `koi-prose-style/examples.md`.
